...
path = "C:/Users/Ronit/Desktop/CNS/Video-Encryption-Decryption-main/Images/front.jpg"
...
def encrypt_fun():
    ...
    flag=1
    path_list = []
    path="C:/Users/Ronit/Desktop/CNS/Video-Encryption-Decryption-main"
    ...
    try:
        ...
        if not os.path.exists('C:/Users/Ronit/Desktop/CNS/Video-Encryption-Decryption-main/Video_Images'):
            os.makedirs('C:/Users/Ronit/Desktop/CNS/Video-Encryption-Decryption-main/Video_Images')
...
def decrypt_fun():
    ...
    if flag == 1:
        ...
        ##
        source1 = cv2.VideoCapture("C:/Users/Ronit/Downloads/video.mp4")
        currentframe = 0
        x2=0
        while (True):
            # reading from frame
            ...
            if ret:
                if currentframe % 60 == 0:
                    ...
                    name ="C:/Users/Ronit/Desktop/CNS/Video-Encryption-Decryption-main/Images/sample.jpg"
                    # name = path +'/Video_Images/frame' + str(x1) + '.jpg'
                    # print(x1, end = " ")
                    x2 = x2 + 1
                    #         print ('Creating...' + name)
